...
def heatmap_canton(df, CANTON, TIPO, last_column=0, hm='General'):
    ...
    if hm == 'General':
        ...
        # ax.vlines([14,24,31,143,146,148,151,154,157,160,163,164,165,168,169,170], *ax.get_ylim()) #adds vertical lines for specific dates
    elif hm == 'Normal':
        ...
        # ax.vlines([14,24,31,143,146,148,151,154,157,160,163,164,165,168,169,170], *ax.get_ylim())
...
heatmap_canton(cases, 'QUITO', 'URBANA', 174)
...
heatmap_canton(cases, 'QUITO', 'RURAL', 174)
